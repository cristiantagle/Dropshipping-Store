    ...
    <div className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-purple-50 via-pink-50 to-amber-50">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="p-10 text-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-3">
          <Link href="/categorias" className="inline-flex items-center justify-center rounded-xl px-4 py-2 font-medium bg-black text-white hover:opacity-90">Explorar categorías</Link>
          <Link href="/carro" className="inline-flex items-center justify-center rounded-xl px-4 py-2 font-medium border">Ver carro</Link>
        </div>
      </motion.div>
