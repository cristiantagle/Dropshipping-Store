          ...
          <li key={p.id} className="border rounded-2xl p-4 hover:bg-gray-50 transition">
            <div className="aspect-[4/3] w-full mb-3 overflow-hidden rounded-xl bg-gray-100">
              <img
                ...
                loading="lazy" decoding="async" referrerPolicy="no-referrer" onError={onErr}
              />
            </div>
            ...
            <div className="mt-2 flex items-center justify-between">
              ...
              <button className="px-3 py-1 rounded-xl bg-black text-white text-sm" onClick={() => alert(`Agregado: ${p.nombre}`)}>
                Agregar
              </button>
            </div>
          </li>
