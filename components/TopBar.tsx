        ...
        <div className="h-14 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="inline-flex items-center gap-2 font-semibold text-neutral-900 hover:opacity-80">
              <span className="inline-block rounded-md bg-emerald-600 text-white px-2 py-0.5 text-xs tracking-wide">LN</span>
          ...
          {/* Acciones derechas (placeholder sin deps externas) */}
          <div className="flex items-center gap-2">
            <Link
              href="/categorias"
              className="hidden md:inline-flex items-center rounded-full px-3 py-1.5 text-sm border border-emerald-600 text-emerald-700 hover:bg-emerald-50 transition"
            >
              Explorar
            </Link>
          </div>
