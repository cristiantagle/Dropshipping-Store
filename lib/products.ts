...
export const productos: Producto[] = [
  { id: "hogar-001", nombre: "Organizador plegable multiuso", precio: 12990, imagen: "https://images.unsplash.com/photo-1541562232579-512a21360020?q=80&w=1200&auto=format&fit=crop", categoria: "Hogar", envio: "Rápido (stock local)" },
  ...
  { id: "beauty-001", nombre: "Set brochas compactas", precio: 14990, imagen: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?q=80&w=1200&auto=format&fit=crop", categoria: "Belleza", envio: "Rápido (stock local)" },
  ...
  { id: "tech-001", nombre: "Soporte aluminio para notebook", precio: 19990, imagen: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=1200&auto=format&fit=crop", categoria: "Tecnología", envio: "Rápido (stock local)" },
