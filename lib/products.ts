export type Producto = {
  id: string;
  nombre: string;
  categoria: string; // slug: "belleza" | "hogar" | "tecnologia"
...
export const productos: Producto[] = [
  // Belleza
  { id: "b1", nombre: "Rizador cerámico 28mm", categoria: "belleza", envio: "Internacional 12–25 días", precio: 19990, imagen: "https://images.unsplash.com/photo-1618173419590-8aa0e9c04aa8?q=80&w=1200&auto=format&fit=crop", destacado: true },
  ...
  // Hogar
  { id: "h1", nombre: "Organizador plegable de clóset", categoria: "hogar", envio: "Internacional 12–25 días", precio: 13990, imagen: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1200&auto=format&fit=crop", destacado: true },
  ...
  // Tech
  { id: "t1", nombre: "Cargador rápido 20W USB-C", categoria: "tecnologia", envio: "Internacional 12–25 días", precio: 11990, imagen: "https://images.unsplash.com/photo-1555617981-dac3880f27df?q=80&w=1200&auto=format&fit=crop", destacado: true },
