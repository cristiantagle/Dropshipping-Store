...
/**
 * Mapa de normalización: acepta variantes con mayúsculas, acentos u otras
 * categorías “de marketing” y las mapea a nuestros slugs canónicos.
 */
const mapa: Record<string, Slug> = {
  ...
  "belleza (accesorios)".toLowerCase(): "belleza",
  "Belleza": "belleza",
  ...
  // Otras posibles entradas “de marketing” → forzamos a alguna categoría
  "bienestar": "belleza",
  "eco": "hogar",
  "mascotas": "hogar"
};
