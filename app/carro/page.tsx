      ...
      {detalle.length === 0 ? (
        ...
        <>
          ...
          <div className="flex gap-3">
            <button onClick={pagar} className="px-4 py-2 rounded-lg bg-black text-white">Pagar con Mercado Pago</button>
            <button onClick={limpiar} className="px-4 py-2 rounded-lg border">Limpiar</button>
          </div>
        </>
      )}
    </section>
