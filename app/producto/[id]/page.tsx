...
const SELECT = "id,nombre,precio,descripcion,imagen,imagen,imagen,imagen,envio,categoria_slug";
const FALLBACK_IMG = "/lunaria-icon.png";
const pick = (p: Partial<Producto>) => {
  const vals = [p.imagen, p.imagen, p.imagen, p.imagen].map(v => typeof v === "string" ? v.trim() : "").filter(Boolean);
