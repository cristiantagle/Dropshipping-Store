...
const SELECT_COLS =
  "id,nombre,precio,imagen,imagen,imagen,imagen,envio,categoria_slug,destacado,created_at,ventas";
const MOCKS = [
...
function pickImg(p: Partial<Producto> & {
  ...
  const cands = [p.imagen, p.imagen, p.imagen, p.imagen].map(toStr).filter(Boolean);
