...
export const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  oficina: [
    "office", "desk", "chair", "stationery", "pen", "pencil", "marker",
    "notebook", "paper", "folder", "file", "binder", "clip", "stapler",
    "staple", "paperclip", "rubber band", "tape", "scissor", "ruler",
    "calculator", "organizer", "tray", "holder", "stand", "rack", "cabinet",
    "drawer", "shelf", "bookshelf", "filing", "document", "planner",
    "agenda", "calendar", "schedule", "memo", "sticky note", "post-it",
    "whiteboard", "blackboard", "marker board", "cork board", "bulletin",
    "printer", "scanner", "fax", "shredder", "laminator", "binding",
    "punch", "hole punch", "stamp", "ink pad", "envelope", "mailing",
    "business", "corporate", "professional", "workplace", "workspace",
    "meeting", "conference", "presentation", "projector", "screen",
    "supplies", "equipment", "furniture", "storage", "archive"
  ],
};
