    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col">
          ...
          {/* Tabs */}
          <Tabs product={product} longDesc={longDesc} />
        </div>
      </div>
...
function Tabs({ product, longDesc }: { product: Product; longDesc?: string }) {
      ...
      <div className="flex border-b">
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "descripcion" ? "border-b-2 border-lime-600 text-lime-600" : "text-gray-600"
          }`}
        ...
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "envio" ? "border-b-2 border-lime-600 text-lime-600" : "text-gray-600"
          }`}
        ...
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "opiniones" ? "border-b-2 border-lime-600 text-lime-600" : "text-gray-600"
          }`}
